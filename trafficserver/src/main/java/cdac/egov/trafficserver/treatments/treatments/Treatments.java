package cdac.egov.trafficserver.treatments.treatments;
...
public class Treatments implements Serializable {
	...
	public Treatments(TreatmentsModel treatmentsModel) {
		this.id = treatmentsModel.id;
		this.districtName = treatmentsModel.districtName;
		this.numberOfTreatmentRecommendations = treatmentsModel.numberOfTreatmentRecommendations;
		this.startYear = treatmentsModel.startYear;
		this.durationYears = treatmentsModel.durationYears;
	}
